...
import com.plcoding.cryptocurrencyappyt.data.remote.dto.CoinsList.toCoins
...
class GetCoinsUseCase @Inject constructor(
    ...
    operator fun invoke(): Flow<Resource<List<Coin>>> = flow {
        try{
            ...
            Log.d("mytag", repository.getCoins().toString())
            val coins = repository.getCoins().map{it.toCoins()}//we want to return List<Coin> and not List<CoinDto>
